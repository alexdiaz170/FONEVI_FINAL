...
if (process.env.REQUIRED_RUN_SEED !== 'true') {
  console.error(
    'REQUIRED_RUN_SEED != "true" — To run the seed set REQUIRED_RUN_SEED=true in your environment. Aborting.',
  );
  process.exit(1);
}
...
async function main() {
  ...
  const usuarios = [
    ...
    },
    {
      ...
      email: 'tesorero@fonevi.edu.co',
      password: 'Tesorero2026!',
      rol: 'tesorero',
      avatar: 'LJ',
    },
    {
      nombre: 'Ana Torres',
      email: 'ana.torres@fonevi.edu.co',
      password: 'Socio2026!',
      rol: 'socio',
      avatar: 'AT',
    },
  ...
  await prisma.notificacion.create({
    data: {
      ...
      mensaje: 'El sistema ha sido reiniciado con los datos base.',
      leida: false,
      urgente: false,
    },
  });
  ...
  console.log(
    'NOTE: Default credentials are NOT printed. Use your secrets manager or check the seed configuration in a secure environment.',
  );
  console.log(
    'If you need to run this seed locally, set REQUIRED_RUN_SEED=true and NODE_ENV!=production.',
  );
  console.log('─'.repeat(50));
}
