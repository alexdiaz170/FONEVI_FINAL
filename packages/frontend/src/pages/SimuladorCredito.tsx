...
export default function SimuladorCreditoPage() {
  ...
  if (usuario?.rol !== 'socio') return <AdminInfo />;
  return <SocioSimulator />;
}
    ...
    <div className="relative">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Disponible solo para socios</p>
        </div>
      </div>
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
        <div className="w-16 h-16 rounded-full bg-navy-100 flex items-center justify-center mx-auto mb-4">
          <PiggyBank size={28} className="text-navy-500" />
        </div>
        <p className="text-navy-700 font-medium">
          El simulador de crédito está disponible solo para socios.
        </p>
        <p className="text-gray-400 text-sm mt-1">
          Inicia sesión con un perfil de socio para usarlo.
        </p>
      </div>
    </div>
  );
