...
function doLogout() {
  if (confirm('¿Deseas cerrar sesión?')) {
    ...
    // Navegar al login
    var enPages =
      window.location.pathname.includes('/pages/') || window.location.pathname.includes('/app/');
    ...
    (async () => {
      try {
        ...
        if (typeof window.refreshUI === 'function') {
          ...
          if (
            typeof renderCategorias === 'function' &&
            typeof tabActual !== 'undefined' &&
